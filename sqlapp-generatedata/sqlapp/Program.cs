...
string strFilePath = "C:\\Users\\jairo\\OneDrive\\Documentos\\jairo\\Az305\\Codes\\AZ305-Codes\\sqlapp-generatedata\\sqlapp\\files\\Log.csv";
StreamReader? logReader =null;
int Id = 1;
SqlConnection appdbConnection =
    new SqlConnection("Server=52.177.71.226,1433;Initial Catalog=appdb;Persist Security Info=False;User ID=azureuser;Password=User1Pass@*#*;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=True;Connection Timeout=30;");
